...
class Date extends Field
{
     ...
     */
    public const STYLE_NONE = 'PKDateStyleNone';

    public const STYLE_SHORT = 'PKDateStyleShort';

    public const STYLE_MEDIUM = 'PKDateStyleMedium';

    public const STYLE_LONG = 'PKDateStyleLong';

    public const STYLE_FULL = 'PKDateStyleFull';

    /** @var array<string> */
    private $validStyles = [
        self::STYLE_NONE, self::STYLE_SHORT, self::STYLE_MEDIUM, self::STYLE_LONG, self::STYLE_FULL,
    ];
